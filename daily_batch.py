...
# =========================================================
# AI予測バッチ処理 (daily_batch.py) - LightGBM・通知なし完全版
# =========================================================
...
def generate_signals():
    logger.info("🧠 AI予測バッチ処理(LightGBMモデル)を開始します...")
    ...
    for name, ticker in tickers.items():
        ...
        res_dict = {
            ...
            "メタ確信度": float(meta_confidence * 100), # 🔥 ケリー基準に必要な確信度
